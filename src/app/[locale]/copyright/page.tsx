...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - RNG Heroes Wiki',
    description: 'Copyright and intellectual property information for RNG Heroes Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - RNG Heroes Wiki',
      description: 'Copyright and intellectual property information for RNG Heroes Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 RNG Heroes Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of RNG Heroes Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              RNG Heroes Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Operator of the Roblox platform</li>
              <li><strong>RNG Heroes Developers</strong> - Creators of the RNG Heroes game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>RNG Heroes</strong> - Trademark of the game developers</li>
              <li><strong>RNG Heroes Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with RNG Heroes Wiki.
            </p>
            ...
            <p>
              ...
              RNG Heroes Wiki<br />
              Email: <a href="mailto:dmca@rng-heroes.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rng-heroes.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "RNG Heroes Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: RNG Heroes Wiki (rng-heroes.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@rng-heroes.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@rng-heroes.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@rng-heroes.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rng-heroes.wiki</a>
            </p>
            <p>

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - RNG Heroes Wiki",
    description: "Read the Terms of Service for RNG Heroes Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - RNG Heroes Wiki",
      description: "Terms and conditions for using RNG Heroes Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using RNG Heroes Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using RNG Heroes Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and RNG Heroes Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              RNG Heroes Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "RNG Heroes". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active codes and redemption guides</li>
              <li>Hero tier lists and rarity references</li>
              <li>Roll odds, Luck, and upgrade guides</li>
              <li>Zone, biome, and progression information</li>
              <li>Monster and combat guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> RNG Heroes Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of RNG Heroes. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by RNG Heroes Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of RNG Heroes. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> RNG Heroes is regularly updated with new heroes, zones, codes, and balance changes. Information may become outdated as the game evolves, and we are not responsible for game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, RNG HEROES WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and RNG Heroes Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@rng-heroes.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@rng-heroes.wiki</a>
            </p>
            <p>
